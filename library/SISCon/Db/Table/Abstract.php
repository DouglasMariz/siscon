...
/**
 * Siscon_Db_Table_Abstract
 */
abstract class Siscon_Db_Table_Abstract extends Zend_Db_Table_Abstract implements Siscon_Db_Table_Interface
{
	const INT_TYPE = 0;
	const FLOAT_TYPE = 1;
	 ...
	 * @var string
	 */
	protected static $_dbTableNamespace =  'Externo_Model_';
	...
	public function __construct(array $options = array())
	{
		...
		$this->setRowClass('Siscon_Db_Table_Row_Abstract');
	...
	public function getTypeElement($fieldName)
	{
		...
		{
			return Siscon_Form_Constants::TEXT;
		}
	 ...
	 * @see Siscon_Db_Table_Interface::getSelectOptions()
	 */
