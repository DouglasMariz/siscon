 ...
 * @subpackage Siscon_Controller_Action_Abstract
 * @copyright  Copyright (c) 2012 Douglas Thyago Mariz de Assis (http://www.siscon.com.br)
 * @license   New BSD License
 * @version    1.0.0
 */
/**
 * Siscon_Controller_Abstract
 */
abstract class Siscon_Controller_Action_Abstract extends Zend_Controller_Action implements Siscon_Controller_Action_Interface
{
	/**
	 * model object used by controller
	 * @var Siscon_Model_Abstract
	 */
	protected $_model;
	/**
	 * action name
